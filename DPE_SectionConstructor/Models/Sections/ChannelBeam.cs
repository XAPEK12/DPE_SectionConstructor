...
{
    public class ChannelBeam : Section
    {
        public ChannelBeam()
        {
            Name = "Швеллер";
        ...
        public override void GetSectionData()
        {
            ...
            {
                //                           X               Y
                new OxyPlot.DataPoint(  b-X0     ,   h/2        ),
                new OxyPlot.DataPoint(  b-X0     ,   h/2-s+r    ),
                new OxyPlot.DataPoint(  b-X0-r   ,   h/2-s+r    ),
                new OxyPlot.DataPoint(  b-X0-r   ,   h/2-s      ),
        ...
        {
            return new ChannelBeam() { h = this.h, b = this.b, s = this.s, t = this.t, r = this.r, R = this.R, d = this.d, smX = this.smX, smY = this.smY, Angle = this.Angle };
        }
